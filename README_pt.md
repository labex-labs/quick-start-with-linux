...
<p align="center">
  <a href="https://labex.io/pt/courses/quick-start-with-linux">
    <img width="640" src="https://course-cover.labex.io/quick-start-with-linux.png?lang=pt" alt="Início Rápido com Linux">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/quick-start-with-linux)

## Exercícios

|   Índice | Nome                                  | Dificuldade   | Prática                                                                                                                                            |
|----------|---------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
|       01 | Seu Primeiro Laboratório Linux        | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/your-first-linux-lab-270253?course=quick-start-with-linux'>Iniciar Lab</a>                       |
...
|       03 | Operações Básicas de Arquivos         | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/basic-files-operations-270248?course=quick-start-with-linux'>Iniciar Lab</a>                     |
...
|       05 | Conteúdo e Comparação de Arquivos     | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/file-contents-and-comparing-270251?course=quick-start-with-linux'>Iniciar Lab</a>                |
...
|       07 | Permissões de Arquivos                | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/permissions-of-files-270252?course=quick-start-with-linux'>Iniciar Lab</a>                       |
|       08 | Alterar a Propriedade de Arquivos     | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/shell-change-the-ownership-270254?course=quick-start-with-linux'>Iniciar Desafio</a>             |
