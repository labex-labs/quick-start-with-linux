...
<p align="center">
  <a href="https://labex.io/es/courses/quick-start-with-linux">
    <img src="https://course-cover.labex.io/quick-start-with-linux.png?lang=es" alt="Inicio rápido con Linux">
  </a>
</p>
...
|----------|----------------------------------------|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
|       01 | Tu primer laboratorio de Linux         | Principiante | <a target='_blank' href='https://labex.io/es/labs/your-first-linux-lab-270253?course=quick-start-with-linux'>Iniciar lab</a>                       |
...
|       03 | Operaciones básicas con archivos       | Principiante | <a target='_blank' href='https://labex.io/es/labs/basic-files-operations-270248?course=quick-start-with-linux'>Iniciar lab</a>                     |
...
|       05 | Contenido y Comparación de Archivos    | Principiante | <a target='_blank' href='https://labex.io/es/labs/file-contents-and-comparing-270251?course=quick-start-with-linux'>Iniciar lab</a>                |
...
|       07 | Permisos de archivos                   | Principiante | <a target='_blank' href='https://labex.io/es/labs/permissions-of-files-270252?course=quick-start-with-linux'>Iniciar lab</a>                       |
|       08 | Cambiar la Propiedad de un Archivo     | Principiante | <a target='_blank' href='https://labex.io/es/labs/shell-change-the-ownership-270254?course=quick-start-with-linux'>Iniciar desafío</a>             |
