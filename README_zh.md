...
<p align="center">
  <a href="https://labex.io/zh/courses/quick-start-with-linux">
    <img src="https://course-cover.labex.io/quick-start-with-linux.png?lang=zh" alt="Linux 快速入门">
  </a>
</p>
...
|   序号 | 名称             | 难度   | 练习                                                                                                                                      |
|------|----------------|------|-----------------------------------------------------------------------------------------------------------------------------------------|
|   01 | 你的第一个 Linux 实验 | 初级   | <a target='_blank' href='https://labex.io/zh/labs/your-first-linux-lab-270253?course=quick-start-with-linux'>开始实验</a>                   |
...
|   03 | 基础文件操作         | 初级   | <a target='_blank' href='https://labex.io/zh/labs/basic-files-operations-270248?course=quick-start-with-linux'>开始实验</a>                 |
...
|   05 | 文件内容查看与比较      | 初级   | <a target='_blank' href='https://labex.io/zh/labs/file-contents-and-comparing-270251?course=quick-start-with-linux'>开始实验</a>            |
...
|   07 | 文件权限管理         | 初级   | <a target='_blank' href='https://labex.io/zh/labs/permissions-of-files-270252?course=quick-start-with-linux'>开始实验</a>                   |
|   08 | 更改文件所有权        | 初级   | <a target='_blank' href='https://labex.io/zh/labs/shell-change-the-ownership-270254?course=quick-start-with-linux'>开始挑战</a>             |
