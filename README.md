...
**Languages:** [简体中文](README_zh.md) · [Español](README_es.md) · [Français](README_fr.md) · [Deutsch](README_de.md) · [日本語](README_ja.md) · [Русский](README_ru.md) · [한국어](README_ko.md) · [Português](README_pt.md) · [English](README.md)

<p align="center">
  <a href="https://labex.io/courses/quick-start-with-linux">
    <img width="128" src="https://course-cover.labex.io/quick-start-with-linux.png" alt="Quick Start with Linux">
  </a>
</p>
...
[Start Course on LabEx](https://labex.io/courses/quick-start-with-linux)

## Exercises

|   Index | Name                               | Difficulty   | Practice                                                                                                                                        |
|---------|------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
|      01 | Your First Linux Lab               | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-your-first-linux-lab-270253?course=quick-start-with-linux'>Start Lab</a>                   |
...
|      03 | Basic Files Operations             | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-basic-files-operations-270248?course=quick-start-with-linux'>Start Lab</a>                 |
